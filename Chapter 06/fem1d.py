...
Original file is located at
    https://colab.research.google.com/drive/1AKBKv9p0mMzjVDVc08M91LzGaUSIVBqQ
...
# --- Connectivity matrix
connectivityMatrix      = np.zeros((numNodesPerElement, numElements), dtype = np.int32)              
     
# --- Loop over all elements
for e in range(numElements):
    connectivityMatrix[0, e] = e       
    connectivityMatrix[1, e] = e + 1
